          ...
          <Card>
            ...
            <CardContent>
              <div className="flex gap-4">
                  <button onClick={() => updateSettings(draft => {draft.theme = 'light'})} className={cn("flex flex-col items-center gap-2 p-4 border-2 rounded-lg w-full", settings.theme === 'light' ? 'border-accent' : 'border-transparent')}>
                      <div className="w-16 h-10 rounded-md bg-gray-200 flex items-center justify-center"><Sun className="text-gray-600"/></div>
                      <span>روشن</span>
                  </button>
                  <button onClick={() => updateSettings(draft => {draft.theme = 'dark'})} className={cn("flex flex-col items-center gap-2 p-4 border-2 rounded-lg w-full", settings.theme === 'dark' ? 'border-accent' : 'border-transparent')}>
